...
describe("Layout Organization with cycles", () => {
    describe("when single node depends on itself", () => {
        let graph = new Graph();
    ...
    describe("when middle node depends on itself", () => {
        let graph = new Graph();
    ...
    describe("when graph contains a single long cycle", () => {
        let graph = new Graph();
        ...
        it("Aron should be on 1st layer", () => {
            expect(layers[0]).to.contain("Aron");
        });
    });
});
